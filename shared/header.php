      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/odc/admin/users-profile.php">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="/odc/pages-faq.php">
            ...
            <li>
              <span class="dropdown-item d-flex align-items-center" >
                <i class="bi bi-box-arrow-right"></i>
                  ...
                  <button class="btn btn-warning " name="logout" type="submit">Sign out</button>
                </form>
